...
def num_feedback(num):
    return sorted(feedbackInput, key=lambda bm:bm['date'], reverse=True)[:num]
...
@app.route('/index')
def index():
    return render_template("index.html", new_feedback = num_feedback(3))
